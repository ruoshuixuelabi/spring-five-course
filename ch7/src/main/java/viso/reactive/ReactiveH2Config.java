...
import viso.r2dbc.entity.converter.UserDOWriteConveter;
import viso.r2dbc.entity.converter.UserDoReadConverter;
...
//                        .url("r2dbc:h2:mem:stocktest;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE")
//                        .username("admin")
//                        .password("password")
//                        .build()
//        );
